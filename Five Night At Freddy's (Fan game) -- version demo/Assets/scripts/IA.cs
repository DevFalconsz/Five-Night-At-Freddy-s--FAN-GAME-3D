...
public class IA : MonoBehaviour {
    ...
    public float DistanciaDePercepcao = 9999, DistanciaDeSeguir = 9990, DistanciaDeAtacar = 2, VelocidadeDePasseio = 3, VelocidadeDePerseguicao = 9, TempoPorAtaque = 1.5f, DanoDoInimigo = 100;
    ...
    void Update()
    {
        ...
        if (Physics.Raycast(transform.position, direction, out hit, 999) && DistanciaDoPlayer < DistanciaDePercepcao)
        {
